...
```bash
pipx install --force "plugin-scanner==3.4.4"
plugin-scanner scan . --format text
```

Expected reviewed wheel SHA256: `5defae79f7bf171544b01ae1e95565558a21fa7d20c611a60b711c28b42aa7bc`

If you want to verify the exact wheel before install:

```bash
rm -rf .hol-plugin-scanner-dist
python3 -m pip download --only-binary=:all: --no-deps --dest .hol-plugin-scanner-dist "plugin-scanner==3.4.4"
